...
#
# Script generated by Vivado on Wed Aug 06 21:25:42 +0400 2025
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_6.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
