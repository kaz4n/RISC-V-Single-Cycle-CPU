...
#
# Script generated by Vivado on Thu Aug 07 07:58:08 +0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_5 xil_defaultlib.design_5 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_5 -key {Behavioral:sim_1:Functional:design_5} -tclbatch cmd.tcl -protoinst "protoinst_files/design_6.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/design_4.protoinst" -protoinst "protoinst_files/design_5.protoinst" -log simulate.log
}
