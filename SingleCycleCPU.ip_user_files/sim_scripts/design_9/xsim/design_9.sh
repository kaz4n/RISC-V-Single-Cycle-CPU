...
#
# Script generated by Vivado on Thu Aug 07 13:52:17 +0400 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_9.sh
...
#
# Usage        : design_9.sh
#                design_9.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_9.sh [-reset_run]
#                design_9.sh [-reset_log]
#                design_9.sh [-help]
#
...
# script info
echo -e "design_9.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_9.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_9 xil_defaultlib.design_9 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_9 -key {Behavioral:sim_1:Functional:design_9} -tclbatch cmd.tcl -protoinst "protoinst_files/design_6.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/design_4.protoinst" -protoinst "protoinst_files/design_5.protoinst" -protoinst "protoinst_files/design_7.protoinst" -protoinst "protoinst_files/design_8.protoinst" -protoinst "protoinst_files/design_9.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_9.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_9.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_9.sh [-help]\n\
Usage: design_9.sh [-step]\n\
Usage: design_9.sh [-lib_map_path]\n\
Usage: design_9.sh [-reset_run]\n\
Usage: design_9.sh [-reset_log]\n\
Usage: design_9.sh [-keep_index]\n\
Usage: design_9.sh [-noclean_files]\n\n\
