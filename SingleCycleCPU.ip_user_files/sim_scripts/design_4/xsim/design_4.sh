...
#
# Script generated by Vivado on Wed Aug 06 21:59:11 +0400 2025
...
# script info
echo -e "design_4.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_4 xil_defaultlib.design_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_4 -key {Behavioral:sim_1:Functional:design_4} -tclbatch cmd.tcl -protoinst "protoinst_files/design_6.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/design_4.protoinst" -log simulate.log
}
